...
tar zxvf snmp_exporter-0.20.0.linux-amd64.tar.gz >/dev/null

cp snmp_exporter-0.20.0.linux-amd64/snmp_exporter /usr/local/bin/snmp_exporter
cp snmp_exporter-0.20.0.linux-amd64/snmp.yml /etc/prometheus/snmp.yml
